...
extern float cfg_c_value;
extern int cfg_visit_tengen;
extern int cfg_visit_mirror;
extern int cfg_add_tengen;
extern int cfg_add_mirror;
extern int cfg_fraction_tengen;
extern int cfg_fraction_mirror;
